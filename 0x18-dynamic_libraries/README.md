...
**Solution:** [libdynamic.so](https://github.com/edwardmuss/alx-low_level_programming/blob/main/0x18-dynamic_libraries/libdynamic.so), [main.h](https://github.com/edwardmuss/alx-low_level_programming/blob/main/0x18-dynamic_libraries/main.h)

## Without libraries what have we? We have no past and no future

Create a script that creates a dynamic library called `liball.so` from all the `.c` files that are in the current directory.

**Solution:** [1-create_dynamic_lib.sh](https://github.com/edwardmuss/alx-low_level_programming/blob/main/0x18-dynamic_libraries/1-create_dynamic_lib.sh)
...
**Solution:** [100-operations.so](https://github.com/edwardmuss/alx-low_level_programming/blob/main/0x18-dynamic_libraries/100-operations.so)
...
**Solution:** [101-make_me_win.sh](https://github.com/edwardmuss/alx-low_level_programming/blob/main/0x18-dynamic_libraries/101-make_me_win.sh)
